...
### 归并排序是先左和右搞定，在合并成一个，不要在搞错了！-- 搞了一遍，很顺利，Jun-25
### 528如何使用二分查找？ -- 搞定了，这个right一开始设定错误，是n - 1，而不是n，因为n是开区间1，不会达到
### 315还需要再做一下 -- l.n <= r.n，因为否则相等时会先放右边的内容
### 416有好多种方法 -- 一举拿下，看来知道了，以后再试试
### 518这个还要在做一遍,322 -- 518也很顺利，322可以
